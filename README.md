...
Props are like argument used to send data from a parent component to a child component.
State is a data that belongs to a component and can change and store the change.
